                              ...
                              children: [
                                          ...
                                          child: SizedBox(
                                            child: ClipRRect(
                                              ...
                                              child: Image(
                                                ...
                                                image: NetworkImage(
                                                    "${snapshot.data?.items?[index]?.volumeInfo?.imageLinks?.thumbnail ?? 'https://img.freepik.com/premium-photo/book-cover-ready-text-graphic-isolated-white_960782-61449.jpg?w=360'}"),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        "${snapshot.data?.items![index].volumeInfo!.authors?.isNotEmpty == true ? snapshot.data?.items![index].volumeInfo!.authors![0] : "Not Found"}",
                                        maxLines: 1,
